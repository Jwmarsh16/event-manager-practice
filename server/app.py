...
def unset_jwt():
    # Clear JWT cookies
    resp = make_response(redirect('/login', 302))  # Redirect to login page
    unset_jwt_cookies(resp)  # Unset the JWT tokens
    return resp
...
class Login(Resource):
    def get(self):
        # You can render a login template or just return a message indicating the login page
